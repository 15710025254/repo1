...
public class InsEquipmentEvents : ModelBase
{
    ...
    /// <summary>
    /// 设备信息(主键导航 主表的InsEquipmentInfId关联子表的主键ID)
    /// </summary>
    [SugarColumn(IsIgnore = true)]
    [Navigate(NavigateType.OneToOne, nameof(InsEquipmentInfId))]
    public InsEquipmentInf EquipmentInfo { get; set; }

    /// <summary>
    ///  设备事件类型ID
    ///</summary>
    [SugarColumn(ColumnName = "INS_EQUIPMENT_EVENTS_CATE_ID")]
    public decimal EventsCateId { get; set; }

    /// <summary>
    /// 设备事件类型(主键导航 主表的EventsCateId关联子表的主键ID)
    /// </summary>
    [SugarColumn(IsIgnore = true)]
    [Navigate(NavigateType.OneToOne, nameof(EventsCateId))]
    public InsEquipmentEventsCate EquipmentEventsCate { get; set; }
